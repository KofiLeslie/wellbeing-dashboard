...
@section('content')
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <h6 class="mb-0 text-uppercase">Overall Health Assessment
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (count($physical) > 0)
                        ...
                        <div class="row">
                            <div class="col">
                                <form action="{{ route('emotional.answer') }}" id="myform" method="post"
...
@section('footerLinks')
    <script src="{{ asset('media/js/customjs/emotional.js') }}"></script>
@endsection
