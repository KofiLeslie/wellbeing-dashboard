            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input class="result form-control" type="text" id="date" name="dob" placeholder="Date Picker...">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input class="result form-control" type="text" id="loc" name="loc" placeholder="Location">
                        </div>
                    </div>
