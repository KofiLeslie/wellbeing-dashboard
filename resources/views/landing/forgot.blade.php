...
<head>
  ...
  <link rel="icon" href="{{ asset('media/images/favicon-32x32.png') }}" type="image/png" />
  <!-- Bootstrap CSS -->
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12">
                            <div class="d-grid gap-3">
                              <button type="button" class="btn btn-lg btn-primary radius-30">Send</button>
							                <a href="{{ url('/') }}" class="btn btn-lg btn-light radius-30">Back to Login</a>
                            </div>
                          </div>
                        </div>
                    </form>
