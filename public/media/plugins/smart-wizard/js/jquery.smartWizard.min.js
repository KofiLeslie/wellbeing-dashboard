            ...
            return (
                _createClass(s, [
                    ...
                    },
                    {
                        key: "_createToolbar",
                        value: function (t) {
                            if (0 < this.main.find(".toolbar-" + t).length)
                                return null;
                            var s = v("<div></div>")
                    ...
                    },
                    {
                        key: "_showPrevious",
                        value: function () {
                            var t = this._getPreviousShowable(
                                this.current_index
                            );
                            if (!1 === t) return !1;
                            this._showStep(t);
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                !e.hasClass("disabled") && !e.hasClass("hidden")
                            );
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            var n = this._getStepAnchor(e),
                                o = this._triggerEvent("stepContent", [
                                    n,
                                    e,
                                    i,
                                ]);
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            var s = this,
                                ...
                                o =
                                    this.options.transition.animation.toLowerCase();
