...
class SocialWellbeingEvaluationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('evaluate.social', $this->data);
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            SocialWellbeingEvaluation::insert($arr);
    ...
    public function evaluate(){
        $eva = SocialWellbeingEvaluation::select('question_group',DB::raw('sum(response) as total_score'))->where('user_id', '=', Auth::id())->groupBy('question_group')->get();
